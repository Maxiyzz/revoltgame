...
<head>
    ...
    <title>PlayStation 2 + TV - REVOLT Game</title>
...
<body class="bg-gradient-to-b from-[#0A0F30] to-[#0D1445]">
    ...
    <section class="max-w-6xl mx-auto bg-white rounded-lg shadow-md overflow-hidden flex flex-col md:flex-row">
        <div class="md:w-1/2 h-96">
            <img src="../asset/img/ps2.jpg" alt="PS2 + TV" class="w-full h-full object-cover">
        </div>
        <div class="md:w-1/2 p-8 space-y-6">
            <div class="flex justify-between items-start">
                <h2 class="text-3xl font-bold">PlayStation 2 + Televisi</h2>
                <span class="bg-violet-600 text-white text-xs px-3 py-1 rounded-md">PS2</span>
            </div>
            ...
            <p class="text-gray-700">
                PlayStation 2 dengan disk drive. Nikmati gaming next-gen dengan loading super cepat, haptic feedback, dan grafis memukau.
            </p>
            ...
            <div>
                ...
                <div class="flex flex-wrap gap-2">
                    <span class="bg-gray-100 text-gray-800 px-3 py-1 rounded-full text-sm">Basara Heroes 2</span>
                    <span class="bg-gray-100 text-gray-800 px-3 py-1 rounded-full text-sm">Grand Theft Auto: San Andreas</span>
                    <span class="bg-gray-100 text-gray-800 px-3 py-1 rounded-full text-sm">Resident Evil 4 (2005)</span>
                    <span class="bg-gray-100 text-gray-800 px-3 py-1 rounded-full text-sm">Burnout 3: Takedown</span>
                    <span class="bg-gray-100 text-gray-800 px-3 py-1 rounded-full text-sm">God of War (2005)</span>
                </div>
            </div>
