...
<head>
    ...
    <title>PlayStation 3 Only - REVOLT Game</title>
...
<body class="bg-gradient-to-b from-[#0A0F30] to-[#0D1445]">
    ...
    <section class="max-w-6xl mx-auto bg-white rounded-lg shadow-md overflow-hidden flex flex-col md:flex-row">
        <div class="md:w-1/2 h-96">
            <img src="../asset/img/ps3.jpg" alt="PS3 Only" class="w-full h-full object-cover">
        </div>
        <div class="md:w-1/2 p-8 space-y-6">
            <div class="flex justify-between items-start">
                <h2 class="text-3xl font-bold">PlayStation 3 only</h2>
            ...
            <p class="text-gray-700">
                4K support untuk pengalaman gaming maksimal.
            </p>
